        ...
        return (
            <div id='betrayal-cheatSheet'>
                ...
                <section id='footer'>
                    ...
                    <a href={'https://github.com/poetools/BetrayalCheatSheet'}>Source Code</a>
                </section>
            </div>
        );
    }
        ...
        return (
            <table id='syndicate-table' onClick={this.props.onClick}>
                ...
                <tr>
                    ...
                    <BetrayalTableCell img={'assets/encounters/haku/1transport.png'} alt={'Transport'} description={"Random Items"} id={'t16'} colourID={this.state.selected[TABLE_COL_SIZE + 6]}/>
                    <BetrayalTableCell img={'assets/encounters/hillock/1transport.png'} alt={'Transport'} description={"24/26/28 Quality to Weapon"} id={'t17'} colourID={this.state.selected[TABLE_COL_SIZE + 7]}/>
                    ...
                    <BetrayalTableCell img={'assets/encounters/korell/1transport.png'} alt={'Transport'} description={"Random Essences"} id={'t111'} colourID={this.state.selected[TABLE_COL_SIZE + 11]}/>
                    <BetrayalTableCell img={'assets/encounters/leo/1transport.png'} alt={'Transport'} description={"Silver Coins"} id={'t112'} colourID={this.state.selected[TABLE_COL_SIZE + 12]}/>
                ...
                <tr>
                    ...
                    <BetrayalTableCell img={'assets/encounters/guff/2fort.png'} alt={'Fortification'} description={"10/15/20 Timed Craft"} id={'t25'} colourID={this.state.selected[TABLE_COL_SIZE*2 + 5]}/>
                    ...
                    <BetrayalTableCell img={'assets/encounters/hillock/2fort.png'} alt={'Fortification'} description={"24/26/28 Quality to Armour"} id={'t27'} colourID={this.state.selected[TABLE_COL_SIZE*2 + 7]}/>
                    <BetrayalTableCell img={'assets/encounters/it_that_fled/2fort.png'} alt={'Fortification'} description={"Abyss Jewels"} id={'t28'} colourID={this.state.selected[TABLE_COL_SIZE*2 + 8]}/>
                ...
                <tr>
                    ...
                    <BetrayalTableCell img={'assets/encounters/aisling/3research.png'} alt={'Research'} description={"Add 1-2 Veiled mods to Rare Item"} id={'t31'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 1]}/>
                    ...
                    <BetrayalTableCell img={'assets/encounters/guff/3research.png'} alt={'Research'} description={"10/15/20 Timed Craft"} id={'t35'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 5]}/>
                    <BetrayalTableCell img={'assets/encounters/haku/3research.png'} alt={'Research'} description={"Random Items with Quality"} id={'t36'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 6]}/>
                    <BetrayalTableCell img={'assets/encounters/hillock/3research.png'} alt={'Research'} description={"22/24/26 Quality to Flask"} id={'t37'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 7]}/>
                    <BetrayalTableCell img={'assets/encounters/it_that_fled/3research.png'} alt={'Research'} description={"T1/T2/T3 Upgrade Breachstone"} id={'t38'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 8]}/>
                    ...
                    <BetrayalTableCell img={'assets/encounters/leo/3research.png'} alt={'Research'} description={"Blessed/Divine/Exalt on an Item"} id={'t312'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 12]}/>
                    ...
                    <BetrayalTableCell img={'assets/encounters/vorici/3research.png'} alt={'Research'} description={"1/1-2/1-3 White Sockets on an Item"} id={'t317'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 17]}/>
                </tr>
                <tr>
                    ...
                    <BetrayalTableCell img={'assets/encounters/guff/4intervention.png'} alt={'Intervention'} description={"10/15/20 Timed Craft"} id={'t45'} colourID={this.state.selected[TABLE_COL_SIZE*4 + 5]}/>
                    ...
                    <BetrayalTableCell img={'assets/encounters/hillock/4intervention.png'} alt={'Intervention'} description={"25/30/35 Quality to Map"} id={'t47'} colourID={this.state.selected[TABLE_COL_SIZE*4 + 7]}/>
                    ...
                    <BetrayalTableCell img={'assets/encounters/riker/4intervention.png'} alt={'Intervention'} description={"Div. Card - Timed Take One"} id={'t413'} colourID={this.state.selected[TABLE_COL_SIZE*4 + 13]}/>
